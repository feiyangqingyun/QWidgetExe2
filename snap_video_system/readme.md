...
#### 0.7.1 通用格式
1. **格式要求: url|transport|encodeType|encodeVideo|encodeVideoFps|encodeVideoRatio|encodeVideoScale。**
...
5. encodeVideo表示视频编码格式，0-自动处理(源头是264就264/265就265)，1-强制用264编码，2-强制用265编码。
