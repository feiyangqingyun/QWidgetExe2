...
6. 默认布局文件夹是1920*1080分辨率。用户可以自己在不同分辨率下调整好布局生成布局文件，然后拷贝布局文件夹进行备份。
...
大屏系统效果图： ![](snap/1-1-1-2.jpg)

模块演示效果图： ![](snap/1-1-1-3.jpg)

控件演示效果图： ![](snap/1-1-1-4.jpg)
...
**特别提示**
　　数据库有位数区分，如果是32位的qt，对应打包目录要放32位的数据库的dll，比如放32位的libmysql.dll，不然会提示找不到驱动，而无论32位还是64位的qt程序，都能连接64位的数据库。 
　　意思是在开发阶段，必须放正确位数的dll，而数据库只需要安装64位的即可。sqlserver数据库采用odbc数据源的方式进行连接，而且是微软亲生的，估计在系统层做了无微不至的关怀，qt程序发布的时候啥也不用带。
...
#### 2.7.3 每日合格率统计  ![](snap/2-7-3-1.jpg)
...
　　这个类就像万能胶一样，在本人写的所有的项目中都有，本类就是将平时常用的一些通用函数都丢在这里，不断完善和持续改进，包括了16进制数据转换、图形字体设置、自定义消息框、错误框、提示框等，集成设置窗体居中显示、设置翻译文件、设置编码、设置延时、设置系统时间等静态方法。
 ![](snap/4-4-2-1.jpg)   ![](snap/4-4-2-2.jpg)
...
| switchbutton   | 开关按钮                                                     |
 ...
 ![](snap/4-4-4-2.jpg)   ![](snap/4-4-4-3.jpg)   ![](snap/4-4-4-4.jpg)
 ![](snap/4-4-4-5.jpg)   ![](snap/4-4-4-6.jpg)   ![](snap/4-4-4-7.jpg)
 ![](snap/4-4-4-8.jpg)   ![](snap/4-4-4-9.jpg)
...
## 5 效果图
### 5.1 布局方案
#### 5.1.1 自定义布局1  ![](snap/5-1-1-1.jpg)

#### 5.1.2 自定义布局2  ![](snap/5-1-2-1.jpg)

#### 5.1.3 自定义布局3  ![](snap/5-1-3-1.jpg)

#### 5.1.4 自定义布局4  ![](snap/5-1-4-1.jpg)

#### 5.1.5 自定义布局5  ![](snap/5-1-5-1.jpg)

#### 5.1.6 自定义布局6  ![](snap/5-1-6-1.jpg)

#### 5.1.7 自定义布局7  ![](snap/5-1-7-1.jpg)

#### 5.1.8 自定义布局8  ![](snap/5-1-8-1.jpg)

### 5.2 配色方案
#### 5.2.1 紫色风格  ![](snap/5-2-1-1.jpg)

#### 5.2.2 蓝色风格  ![](snap/5-2-2-1.jpg)

#### 5.2.3 深蓝风格  ![](snap/5-2-3-1.jpg)

#### 5.2.4 黑色风格  ![](snap/5-2-4-1.jpg)

### 5.3 模块效果图
#### 5.3.1 产量汇总  ![](snap/5-3-1-1.jpg)

#### 5.3.2 当月计划  ![](snap/5-3-2-1.jpg)

#### 5.3.3 设备监控  ![](snap/5-3-3-1.jpg)

#### 5.3.4 模具进度  ![](snap/5-3-4-1.jpg)

#### 5.3.5 负荷分布  ![](snap/5-3-5-1.jpg)

#### 5.3.6 送检合格  ![](snap/5-3-6-1.jpg)

#### 5.3.7 品质管理  ![](snap/5-3-7-1.jpg)

#### 5.3.8 物料管理  ![](snap/5-3-8-1.jpg)

#### 5.3.9 视频监控  ![](snap/5-3-9-1.jpg)

#### 5.3.10 大屏地图
##### 5.3.10.1闪烁效果  ![](snap/5-3-10-1-1.jpg)

##### 5.3.10.2 迁徙效果  ![](snap/5-3-10-2-1.jpg)

##### 5.3.10.3 世界地图  ![](snap/5-3-10-3-1.jpg)

##### 5.3.10.4 区域地图  ![](snap/5-3-10-4-1.jpg)

#### 5.3.11 系统设置  ![](snap/5-3-11-1.jpg)   ![](snap/5-3-11-2.jpg)

### 5.4 控件效果图
#### 5.4.1 标准曲线  ![](snap/5-4-1-1.jpg)

#### 5.4.2 曲线面积  ![](snap/5-4-2-1.jpg)

#### 5.4.3 模拟曲线  ![](snap/5-4-3-1.jpg)

#### 5.4.4 标准柱状  ![](snap/5-4-4-1.jpg)

#### 5.4.5 柱状堆积  ![](snap/5-4-5-1.jpg)

#### 5.4.6 柱状分组  ![](snap/5-4-6-1.jpg)

#### 5.4.7 横向柱状  ![](snap/5-4-7-1.jpg)

#### 5.4.8 横向分组  ![](snap/5-4-8-1.jpg)

#### 5.4.9 数据曲线  ![](snap/5-4-9-1.jpg)

#### 5.4.10 平滑曲线  ![](snap/5-4-10-1.jpg)

### 5.5 数据库效果图
#### 5.5.1 数据库-sqlite  ![](snap/5-5-1-1.jpg)

#### 5.5.2 数据库-mysql  ![](snap/5-5-2-1.jpg)

#### 5.5.3 数据库-sqlserver  ![](snap/5-5-3-1.jpg)

#### 5.5.4 数据库-postgresql  ![](snap/5-5-4-1.jpg)
...
#### 5.5.7 数据库-远程访问  ![](snap/5-5-7-1.jpg)
...
### 5.6 各系统运行图
#### 5.6.1 windows-mingw  ![](snap/5-6-1-1.jpg)

#### 5.6.2 windows-msvc  ![](snap/5-6-2-1.jpg) ![](snap/5-6-2-2.jpg)

#### 5.6.3 linux-ubuntu  ![](snap/5-6-3-1.jpg)

#### 5.6.4 linux-uos  ![](snap/5-6-4-1.jpg)

#### 5.6.5 linux-kylin  ![](snap/5-6-5-1.jpg)

#### 5.6.6 linux-neokylin  ![](snap/5-6-6-1.jpg)

#### 5.6.7 linux-fedoar  ![](snap/5-6-7-1.jpg)

#### 5.6.8 unix-mac  ![](snap/5-6-8-1.jpg)